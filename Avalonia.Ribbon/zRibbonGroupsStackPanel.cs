...
{
    public class zRibbonGroupsStackPanel : StackPanel
    {
        public static readonly StyledProperty<Orientation> ChildrenOrientationProperty = StackLayout.OrientationProperty.AddOwner<zRibbonGroupsStackPanel>();
